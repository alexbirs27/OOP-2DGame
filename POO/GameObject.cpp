...
#include <iostream>
#include "Collider.h"
GameObject::GameObject(const char* FLName, int x, int y)
{
    objTexture = TextureManager::LoadTexture(FLName);
...
void GameObject::Get_Input1(const SDL_Event& event,const Map& map)
{
